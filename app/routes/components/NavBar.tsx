    ...
    return (
        <nav className="bg-gray-800 border-b border-gray-700 shadow-md sticky top-0 z-50">
            <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
                ...
                {/* Mobile Menu Toggle */}
                <button className="md:hidden text-blue-400 text-xl cursor-pointer" title="Menu" onClick={() => setMenuOpen(!menuOpen)}>
            ...
            {
                menuOpen && (
                    <div className="md:hidden bg-gray-800 border-t border-gray-700 px-6 py-4 flex flex-col gap-3 text-gray-300">
